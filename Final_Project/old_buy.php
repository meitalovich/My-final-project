...
$tab_query = "SELECT * FROM category ORDER BY cat_id";
...
while($row = mysqli_fetch_array($tab_result))
{
 ...
 {
  $tab_menu .= '
   <li dir="rtl" style="float:center"class="active"><a href="#'.$row["cat_id"].'" data-toggle="tab">'.$row["name"].'</a></li>
  ';
  $tab_content .= '
 ...
 while($sub_row = mysqli_fetch_array($product_result))
 {
  ...
  <img style="float:right"src="'.$sub_row["image"].'" class="img-responsive img-thumbnail" />
     <h4 dir="rtl" style="float:center">'.$sub_row["author"].'</h4>
 <h2 dir="rtl" style="float:right">'.$sub_row["title"].'</h2>
   <h12 dir="rtl" style="float:right">'.$sub_row["description"].' 
<br>
   <span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star"></span>
<span class="fa fa-star"></span></h12>

<h4>'.$sub_row["new_old"].'</h4><br>
   <h3 style="float:center">'.$sub_row["price"].' </h3><br>
   <button class="buy_button" type="submit" style="float:right">קנה</button>
